...
def register_routes(application): # pylint: disable = too-many-statements
	...
	application.add_url_rule("/project/<project_identifier>/repository", methods = [ "GET" ], view_func = project_controller.get_project_repository)
	application.add_url_rule("/project/<project_identifier>/branches", methods = [ "GET" ], view_func = project_controller.get_project_branches)
	application.add_url_rule("/project/<project_identifier>/revisions", methods = [ "GET" ], view_func = project_controller.get_project_revisions)
	application.add_url_rule("/project/<project_identifier>/status", methods = [ "GET" ], view_func = project_controller.get_project_status)
