...
def register_routes(application): # pylint: disable = too-many-statements
	...
	add_url_rule(application, "/job_count", [ "GET" ], job_controller.get_count)
	add_url_rule(application, "/job_collection", [ "GET" ], job_controller.get_collection)
	add_url_rule(application, "/job/<job_identifier>", [ "GET" ], job_controller.get)
	add_url_rule(application, "/job/<job_identifier>/runs", [ "GET" ], job_controller.get_runs)
	add_url_rule(application, "/job/<job_identifier>/trigger", [ "POST" ], job_controller.trigger)
	add_url_rule(application, "/job/<job_identifier>/enable", [ "POST" ], job_controller.enable)
	add_url_rule(application, "/job/<job_identifier>/disable", [ "POST" ], job_controller.disable)
	...
	add_url_rule(application, "/project/<project_identifier>/jobs", [ "GET" ], project_controller.get_jobs)
