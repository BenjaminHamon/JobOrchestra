...
def register_routes(application):
	...
	add_url_rule(application, "/job_collection", [ "GET" ], job_controller.show_collection)
	add_url_rule(application, "/job/<job_identifier>", [ "GET" ], job_controller.show)
	...
	add_url_rule(application, "/schedule_collection", [ "GET" ], schedule_controller.show_collection)
	add_url_rule(application, "/schedule/<schedule_identifier>", [ "GET" ], schedule_controller.show)
